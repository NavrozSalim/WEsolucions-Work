...
class DashboardSummarySerializer(serializers.Serializer):
    ...
    orders_open_count = serializers.IntegerField(required=False, default=0)
    orders_in_shipping_count = serializers.IntegerField(required=False, default=0)
    orders_complete_count = serializers.IntegerField(required=False, default=0)
    orders_recent_count = serializers.IntegerField(required=False, default=0)
